...
function generateSphereFullEye(x, y, z, radius, segments) {
  var vertices = [];
  var colors = [];
...
var triangle_robot_faces = [
  ...
  //Mace Windu
   ...
   var inner_arm_array_Lego = generateCylinderHorizonRotate_Lego(0, 0.3, (CANVAS.width / 3.05), (CANVAS.height / 3.05), [0, 0, 0]);
